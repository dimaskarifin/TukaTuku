...
export const API_KEY = '4b05034428dce3439b5b22f6b50cd52c';
export const ORIGIN_CITY = '179';
...
export const HEADER_MIDTRANS = {
  ...
  Authorization: 'Basic U0ItTWlkLXNlcnZlci1ZT2xJWHkxd3F2WXNleXpUcTlwWVNNRDE=',
};
